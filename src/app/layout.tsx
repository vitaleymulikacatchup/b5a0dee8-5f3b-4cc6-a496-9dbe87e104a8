...
export const metadata: Metadata = {
  title: "Coffee Haven - Your Local Coffee Shop",
  description: "Experience exceptional handcrafted coffee in a warm, welcoming community space. Visit Coffee Haven for specialty drinks, pastries, and genuine connections.",
  keywords: "coffee shop, local coffee, espresso, cappuccino, specialty coffee, pastries",
  metadataBase: new URL("https://coffeehaven.example.com"),
  alternates: {
    canonical: "https://coffeehaven.example.com"
  },
  openGraph: {
    title: "Coffee Haven - Local Coffee Shop",
    description: "Your local coffee sanctuary with handcrafted espresso and warm atmosphere",
    siteName: "Coffee Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765988417663-bexnmnxr.jpg",
        alt: "Coffee Haven cozy interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Coffee Haven - Local Coffee Shop",
    description: "Handcrafted espresso, warm atmosphere, genuine connections",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1765988417663-bexnmnxr.jpg"]
  },
  robots: {
    index: true,
    follow: true
